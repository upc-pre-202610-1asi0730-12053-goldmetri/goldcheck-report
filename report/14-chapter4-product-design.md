...
#### Mapa de Bounded Contexts Frontend
 
El mapa de bounded contexts ofrece una vista panorámica de los once contextos delimitados que conforman el SPA, siguiendo los principios de Domain-Driven Design: Fleet Operations, Material Operations, Jewelry Inventory & Certification, Consumer Traceability, Monitoring & Telemetry, Analytics, Incident Management, Reporting & Notifications, Asset Maintenance, IAM y Subscriptions & Billing.
...
##### BC10 — IAM: Login, Register, Profile
...
El mapa de bounded contexts del backend muestra los once contextos delimitados que componen la API Application (json-server + Express): Fleet Operations, Material Operations, Jewelry Inventory & Certification, Consumer Traceability, Monitoring & Telemetry, Analytics, Incident Management, Reporting & Notifications, Asset Maintenance, IAM y Subscriptions & Billing. Cada contexto encapsula sus propios endpoints REST sobre colecciones independientes del archivo `db.json`, siguiendo los principios de Domain-Driven Design.

![Mapa de Bounded Contexts del Backend](../assets/img/chapter-iv/structurizr-103798-L3_BE_BC_Map.png)

---

#### BC1 — Fleet Operations Bounded Context (Backend)
...
#### BC2 — Material Operations Bounded Context (Backend)
...
#### BC3 — Jewelry Inventory & Certification Bounded Context (Backend)
...
#### BC10 — IAM Bounded Context (Backend)
...
![Diagrama de clase 1](../assets/img/chapter-iv/cdf-fleet-operations.png)

 Mineral Extraction 

![Diagrama de clase 2](../assets/img/chapter-iv/cdf-mineral-extraction.png)

 Custody Chain 

![Diagrama de clase 3](../assets/img/chapter-iv/cdf-custody-chain.png)

 Consumer Experience 

![Diagrama de clase 4](../assets/img/chapter-iv/cdf-consumer-experience.png)

 Monitoring Telemetry 

![Diagrama de clase 5](../assets/img/chapter-iv/cdf-monitoring-telemetry.png)

 Analytics 

![Diagrama de clase 6](../assets/img/chapter-iv/cdf-analytics.png)
...
![Diagrama de clase 8](../assets/img/chapter-iv/cdf-refinery-processing.png)

 Asset Maintenance 

![Diagrama de clase 9](../assets/img/chapter-iv/cdf-asset-maintenance.png)

 Identity & Management 

![Diagrama de clase 10](../assets/img/chapter-iv/cdf-iam.png)
...
![BC1 - Fleet Operations](../assets/img/chapter-iv/BC2_Fleet_Operations_Full.png)

#### BC2 - Material Operations

![BC2 - Material Operations](../assets/img/chapter-iv/BC3_Material_Operations_Full.png)

#### BC3 - Jewelry Inventory

![BC3 - Jewelry Inventory](../assets/img/chapter-iv/BC4_Jewelry_Inventory_Full.png)

#### BC4 - Consumer Traceability

![BC4 - Consumer Traceability](../assets/img/chapter-iv/BC5_Consumer_Traceability_Full.png)

#### BC5 - Monitoring Telemetry

![BC5 - Monitoring Telemetry](../assets/img/chapter-iv/BC6_Monitoring_Telemetry_Full.png)

#### BC6 - Analytics

![BC6 - Analytics](../assets/img/chapter-iv/BC7_Analytics_Full.png)

#### BC7 - Incident Management

![BC7 - Incident Management](../assets/img/chapter-iv/BC8_Incident_Management_Full.png)

#### BC8 - Reporting Notifications

![BC8 - Reporting Notifications](../assets/img/chapter-iv/BC9_Reporting_Notifications_Full.png)

#### BC9 - Asset Maintenance

![BC9 - Asset Maintenance](../assets/img/chapter-iv/BC10_Asset_Maintenance_Full.png)

#### BC10 - Identity Access Management

![BC10 - Identity Access Management](../assets/img/chapter-iv/BC1_Identity_Access_Management_Full.png)
