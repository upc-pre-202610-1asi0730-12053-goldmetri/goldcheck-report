...
|  3.0.0  | 05/07/2026 | García Paredes, Victor Manuel<br>Navarro Aldoradin, Carolina Celeste<br>Philco Mota, Katty Yolanda<br>Tuesta Girón, Kiara Lucia | TB2 — Sprint 4 completo: integración del Frontend Web Application con el Backend real (reemplazo de MockAPI), implementación de mejoras de usabilidad identificadas en la evaluación heurística del AV2, correcciones de responsive design en Landing Page y Web App. Entrevistas de validación adicionales con los tres segmentos. Video About-the-Product mejorado con testimonios de usuarios. Student Outcome TB2, Collaboration Insights TB2 y conclusiones del trabajo final.                                                                |
|  3.1.0  | 05/07/2026 | Tuesta Girón, Kiara Lucia                                                                                                                                         | TB2 — Actualización de Wireframes y Mock-ups del Sprint 4. Implementación del sidebar responsive y mejora del flujo de selección de plan en el onboarding. Integración Frontend-Backend en los bounded contexts Subscriptions & Billing e Incident Management. Entrevistas de validación con el segmento minero. |
|  3.2.0  | 05/07/2026 | Philco Mota, Katty Yolanda                                                                                                                                        | TB2 — Integración Frontend-Backend en el bounded context IAM (autenticación JWT y perfil de usuario). Entrevistas de validación con el segmento joyerías. Actualización del Video About-the-Product con testimonios de los tres segmentos objetivo. |
|  3.3.0  | 07/07/2026 | Navarro Aldoradin, Carolina Celeste                                                                                                                               | TB2 — Actualización de los diagramas C4 Level 3 (componentes por bounded context, separados en capas Application, Domain, Infrastructure e Interfaces). Revisión del Design-Level EventStorming. Implementación de páginas de Términos y Condiciones y Política de Privacidad en la Landing Page. QA general del informe. |
|  3.4.0  | 07/07/2026 | García Paredes, Victor Manuel                                                                                                                                     | TB2 — Documentación completa del Sprint 4: Sprint Planning, Development Evidence, Sprint Backlog y Anexos. Entrevistas de validación con el segmento consumidor. Redespliegue del Backend en Azure App Service. Redacción de conclusiones del TB2. |
